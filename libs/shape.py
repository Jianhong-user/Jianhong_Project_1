...
# 使用HSV颜色空间生成更鲜艳的颜色
# HSV参数：色相(H: 0-360), 饱和度(S: 70-100%), 明度(V: 60-90%), 透明度(A: 180)

# 鲜艳的蓝色线条 - HSV(240, 85%, 80%)
DEFAULT_LINE_COLOR = QColor.fromHsv(240, int(255 * 0.85), int(255 * 0.80), 180)

# 鲜艳的橙色填充 - HSV(30, 90%, 85%)
DEFAULT_FILL_COLOR = QColor.fromHsv(30, int(255 * 0.90), int(255 * 0.85), 180)

# 鲜艳的黄色选中线条 - HSV(60, 95%, 90%)
DEFAULT_SELECT_LINE_COLOR = QColor.fromHsv(60, int(255 * 0.95), int(255 * 0.90), 255)

# 鲜艳的紫色选中填充 - HSV(280, 80%, 75%)
DEFAULT_SELECT_FILL_COLOR = QColor.fromHsv(320, int(255 * 0.85), int(255 * 0.90), 180)

# 鲜艳的青色顶点 - HSV(180, 85%, 85%)
DEFAULT_VERTEX_FILL_COLOR = QColor.fromHsv(180, int(255 * 0.85), int(255 * 0.85), 255)
    ...
    def __setitem__(self, key, value):
        ...
        class Shape(object):
            ...
            def paint(self, painter):
                ...
                def __setitem__(self, key, value):
                    self.points[key] = value
                # 鲜艳的深红色线条 - HSV(0, 85%, 85%)
                DEFAULT_LINE_COLOR = QColor.fromHsv(0, int(255 * 0.85), int(255 * 0.85), 255)
